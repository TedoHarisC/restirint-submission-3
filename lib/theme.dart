...
Color kPrimaryColor = const Color(0xffF05A22);
Color kSecondaryColor = const Color(0xffF9DDCF);
Color kOrangeColor = const Color(0xffF87B4C);
Color kGreyColor = const Color(0xff898989);
